  ...
  <div className='container center main-block'>
    ...
    <ul>
      ...
      <li className='bullet-point'>
        ...
        at point A can be represented by <sup>P</sup>&frasl;<sub><i>p</i></sub>
      </li>
      <li className='bullet-point'>
        ...
        <sup>1</sup>&frasl;<sub>2</sub> V<sup>2</sup>
      </li>
    </ul>
    ...
    <ul>
      ...
      <li className='bullet-point'>
        ...
        will always be the same.  This means that P<sub>standardized</sub> *
        Volume<sub>standardized</sub> = P<sub>calculated</sub> * Volume<sub>calculated</sub>
        which can be rearranged to Volume<sub>standardized</sub> = (Volume<sub>calculated</sub>
        * P<sub>calculated</sub>) / (P<sub>standardized</sub>) so we can calculate
